...
export default async function(fourtune_session) {
	...
	for (const target of targets) {
		...
		files[`src/async.sync/${function_name}/Dependencies<X>Type.d.mts`] =
		...
		files[`src/export/${function_name}<X>.mts`] =
			...
			`import type {ImplementationDocType} from "${import_base_path}/ImplementationDocType.d.mts"\n` +
			`//>import type {ImplementationDocType} from "${import_base_path}/ImplementationSyncDocType.d.mts"\n` +
			`\n` +
			`const impl = factory()\n` +
			`\n` +
		...
		files[`src/export/${function_name}<X>Factory.mts`] =
			...
			`\n` +
			`import implementation from "${import_base_path}/implementation.mts"\n` +
			`//>import implementation from "${import_base_path}/implementationSync.mts"\n` +
			`\n` +
