...
export default async function(fourtune_session) {
	...
	for (const {type, relative_path, absolute_path} of entries) {
		...
		if (!relative_path.endsWith(".mjs")) {
			fourtune_session.addWarning("lib.unsupported_file", {relative_path})
	...
	//
	// sort result for consistent code that will be generated by fourtune
	//
	ret.sort((a, b) => {
	...
	//
	// determine what fourtune should autogenerate
